    ...
    def bucle_general(self):
        while self._corriendo:
            ...
            if campo_info["datos"]["completado"]:
                ...
                if (tipo_accion in ACCION_GENERADOR_SUBMENU or tipo_accion in ACCIONES_MENU_TERMINAL):
                ...
                # Luego, solicitar confirmación si hay respuesta en modo accion
#                if self._estado_interfaz["modo"] == "accion" and self._estado_interfaz["respuesta"]:
